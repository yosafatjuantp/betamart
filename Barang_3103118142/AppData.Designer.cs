...
namespace Barang_3103118142 {
    ...
    public partial class AppData : global::System.Data.DataSet {
        ...
        public partial class EmployeesDataTable : global::System.Data.TypedTableBase<EmployeesRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public EmployeesRow AddEmployeesRow(string kode, string namabarang, string harga, string stok) {
        ...
        public partial class EmployeesRow : global::System.Data.DataRow {
            ...
            public string namabarang {
                get {
                    try {
                        return ((string)(this[this.tableEmployees.namabarangColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'namabarang\' in table \'Employees\' is DBNull.", e);
                    }
                }
                set {
                    this[this.tableEmployees.namabarangColumn] = value;
                }
            }
            ...
            public string stok {
                get {
                    try {
                        return ((string)(this[this.tableEmployees.stokColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'stok\' in table \'Employees\' is DBNull.", e);
                    }
                }
                set {
                    this[this.tableEmployees.stokColumn] = value;
                }
            }
            ...
            public bool IsnamabarangNull() {
                return this.IsNull(this.tableEmployees.namabarangColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public void SetnamabarangNull() {
                this[this.tableEmployees.namabarangColumn] = global::System.Convert.DBNull;
            }
            ...
            public bool IsstokNull() {
                return this.IsNull(this.tableEmployees.stokColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public void SetstokNull() {
                this[this.tableEmployees.stokColumn] = global::System.Convert.DBNull;
            }
        }
...
namespace Barang_3103118142.AppDataTableAdapters {
    ...
    public partial class EmployeesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM `Employees` WHERE ((`EmployeeID` = ?) AND ((? = 1 AND `kode` IS NULL) OR (`kode` = ?)) AND ((? = 1 AND `namabarang` IS NULL) OR (`namabarang` = ?)) AND ((? = 1 AND `harga` IS NULL) OR (`harga` = ?)) AND ((? = 1 AND `stok` IS NULL) OR (`stok` = ?)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `Employees` (`kode`, `namabarang`, `harga`, `stok`) VALUES (?, ?, ?, " +
                "?)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE `Employees` SET `kode` = ?, `namabarang` = ?, `harga` = ?, `stok` = ? WHERE ((`EmployeeID` = ?) AND ((? = 1 AND `kode` IS NULL) OR (`kode` = ?)) AND ((? = 1 AND `namabarang` IS NULL) OR (`namabarang` = ?)) AND ((? = 1 AND `harga` IS NULL) OR (`harga` = ?)) AND ((? = 1 AND `stok` IS NULL) OR (`stok` = ?)))";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Barang_3103118142.Properties.Settings.Default.barangniConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT EmployeeID, kode, namabarang, harga, stok FROM Employees";
        ...
        public virtual int Delete(int Original_EmployeeID, string Original_kode, string Original_namabarang, string Original_harga, string Original_stok) {
        ...
        public virtual int Insert(string kode, string namabarang, string harga, string stok) {
            if ((kode == null)) {
        ...
        public virtual int Update(string kode, string namabarang, string harga, string stok, int Original_EmployeeID, string Original_kode, string Original_namabarang, string Original_harga, string Original_stok) {
            if ((kode == null)) {
